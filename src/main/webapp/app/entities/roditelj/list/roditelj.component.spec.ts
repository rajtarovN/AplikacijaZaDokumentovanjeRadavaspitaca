...
describe('Roditelj Management Component', () => {
  let comp: RoditeljComponent;
  let fixture: ComponentFixture<RoditeljComponent>;
  let service: RoditeljService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'roditelj', component: RoditeljComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(RoditeljComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.roditeljs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
