...
describe('Formular Management Component', () => {
  let comp: FormularComponent;
  let fixture: ComponentFixture<FormularComponent>;
  let service: FormularService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'formular', component: FormularComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(FormularComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.formulars?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
