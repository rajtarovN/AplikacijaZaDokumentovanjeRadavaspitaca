...
export class PlanPriceComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.planPriceService
      ...
      .subscribe({
        next: (res: HttpResponse<IPlanPrice[]>) => {
  ...
  trackId(_index: number, item: IPlanPrice): number {
    return item.id!;
  }

  delete(planPrice: IPlanPrice): void {
    const modalRef = this.modalService.open(PlanPriceDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.planPrice = planPrice;
  ...
  protected onSuccess(data: IPlanPrice[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
