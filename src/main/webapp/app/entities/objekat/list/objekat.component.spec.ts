...
describe('Objekat Management Component', () => {
  let comp: ObjekatComponent;
  let fixture: ComponentFixture<ObjekatComponent>;
  let service: ObjekatService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'objekat', component: ObjekatComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ObjekatComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.objekats?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
