...
describe('PlanPrice Management Component', () => {
  let comp: PlanPriceComponent;
  let fixture: ComponentFixture<PlanPriceComponent>;
  let service: PlanPriceService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'plan-price', component: PlanPriceComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(PlanPriceComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.planPrices?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
