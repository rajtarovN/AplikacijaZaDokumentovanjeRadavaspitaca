...
describe('Dete Management Component', () => {
  let comp: DeteComponent;
  let fixture: ComponentFixture<DeteComponent>;
  let service: DeteService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'dete', component: DeteComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(DeteComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.detes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
