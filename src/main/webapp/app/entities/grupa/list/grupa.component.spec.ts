...
describe('Grupa Management Component', () => {
  let comp: GrupaComponent;
  let fixture: ComponentFixture<GrupaComponent>;
  let service: GrupaService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'grupa', component: GrupaComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(GrupaComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.grupas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
