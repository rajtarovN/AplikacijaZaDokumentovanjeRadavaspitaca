...
describe('Dnevnik Management Component', () => {
  let comp: DnevnikComponent;
  let fixture: ComponentFixture<DnevnikComponent>;
  let service: DnevnikService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'dnevnik', component: DnevnikComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(DnevnikComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.dnevniks?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
