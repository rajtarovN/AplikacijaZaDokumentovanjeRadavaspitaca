...
describe('Prica Management Component', () => {
  let comp: PricaComponent;
  let fixture: ComponentFixture<PricaComponent>;
  let service: PricaService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'prica', component: PricaComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(PricaComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.pricas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
